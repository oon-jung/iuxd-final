    ...
    <div style={{ position: 'absolute', inset: 0, background: '#000', overflow: 'hidden' }}>
      <video ref={videoRef} src="assets/video1.mp4"
        ...
        style={{ position: 'absolute', inset: 0,
                 ...
                 background: '#000' }} />
      {done && (
        <button className="next-btn" style={{ color: '#d9c896', borderColor: '#d9c896',
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: '#0a0a0c',
      ...
      <div style={{ position: 'relative', textAlign: 'center', maxWidth: 780 }}>
        ...
        <div style={{ fontFamily: 'var(--serif)', fontSize: 38, color: '#f5ead0', lineHeight: 1.7,
...
function Page11Feeding({ next }) {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
      <img src={s.bg} alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%',
